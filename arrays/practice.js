...
const removeItem = (myGroceryList, item) => {
  if (myGroceryList && item) {
    return myGroceryList.filter((grocery) => {
      return grocery !== item;
    });
  }
...
const both = (arr1, arr2) => {
  ...
  return arr;
}; //WILL NOT WORK FOR REPEAT NUMBERS IN AN ARRAY
////////// PROBLEM 12 //////////
...
var user3 = {
  name: "Mark kim",
  email: "mark.kimver@devmounta.in",
  password: "her2",
  username: "ihade",
};
